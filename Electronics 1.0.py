...
i=0
print("The input shall represent:")
if(result[0]):
    print("\t{}. Binary number".format(i))
    i+=1
    choice=0
if(result[1]):
    print("\t{}. Hexadecimal number".format(i))
    i+=1
    choice=1
if(result[2]):
    print("\t{}. Octal number".format(i))
    i+=1
    choice=2

if(i!=1):
    print("Please specify which number system you are using to convert the input correctly.")
    choice=int(input("\t: "))
    if(i==2):
        choice+=1
    while(choice>2):
